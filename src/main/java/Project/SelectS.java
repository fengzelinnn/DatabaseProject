...
@WebServlet(name = "selectS", urlPatterns = {"/selectS.do"})
public class SelectS extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String TestSql = "SELECT ID,SUM(flag) FROM DBProject.dbo.ProjectsStu GROUP BY ID";
        ...
        try {
            ...
            String TestSql2 = "SELECT Project FROM DBProject.dbo.ProjectsStu WHERE ID=?";
            ...
            if (flag) {
                ...
                RequestDispatcher requestDispatcher = request.getRequestDispatcher("/SelectStu.jsp");
        ...
        try {
            connection = DriverManager.getConnection(connectionUrl);
            for (String project : projects) {
                String sql = "INSERT INTO DBProject.dbo.ProjectsStu(ProjectId, Project, ID, flag) " +
                        "VALUES (" + "?,?,?,1)";
