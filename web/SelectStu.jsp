...
<form action="selectS.do" method="post">
    <%
    ...
    <%
        ...
        try {
            ...
            String sql;
            sql = "SELECT Project,SUM(flag) FROM DBProject.dbo.ProjectsStu GROUP BY Project";
    ...
    <label>
        <%
            ...
            try {
                ...
                String sql1;
                sql1 = "SELECT ProjectName,ProjectId FROM DBProject.dbo.ProjInfo";
                ResultSet resultSet1 = statement1.executeQuery(sql1);
                while (resultSet1.next()) {
                    String PRJ = resultSet1.getString(1);
                    String PRI = resultSet1.getString(2);
        %>
        <p><input type="checkbox" name="project" value="<%=PRJ%>;<%=PRI%>"><%=PRJ%></p>
    </label>
    <%
            }
        } catch (Exception e) {
